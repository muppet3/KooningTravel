...
<div class="element-item" >
  <div class="col-md-3 box-park" >
    <div class="xcaret">
      ...
      <div style="background:#009626" class="infoinf">
        <div class="hreft1">
          <div class="monya">
        ...
        <div  style="display: none; background:green; "> Ahorra hasta 12 meses sin <br>
          intereses. </div>
      </div>
    </div>
      ...
      <ul class="hotels-list">
        <li class="item hotel">
          <a data-fancybox data-type='iframe' data-src='https://kooningtravel.com/img/tour/terminosycondiciones.pdf' class="thumb"  href='javascript:void(0);'>
            <div class="thumb-images"><img src="/img/tour/parques/Experiencias-Xcaret/Xcaret/Xcaret1.png" alt="el parque"></div>
            <div class="info">
          ...
          <a class="txtt" data-fancybox data-type='iframe' data-src='https://kooningtravel.com/img/tour/EntradaXcaretParque.pdf' href='javascript:void(0);' >
            <p class="hotel-description"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
              tempor incididunt ut labore et dolore magna aliqua.</p>
          </a>
          <a data-fancybox data-type='iframe' data-src='https://kooningtravel.com/img/tour/terminosycondiciones.pdf' class="pdf"  href='javascript:void(0);' >Ver mas...</a>
        </li>
        <li class="item hotel">
          ...
          <div id="tabs">
            ...
            <div id="tabs-1">
              ...
              <a  href="javascript:void(0);">
                <img alt="Mapa del parque el parque!" class="left" src="/img/tour/parques/Experiencias-Xcaret/Xcaret/mapa-xcaret.png" style="margin-top: 0px; max-height: 250px;" />
              </a>
...
<div class="grey-content clear" id="parque-de-atracciones-parques-tematicos">
  <div class="wrapper icon-tickets categoria-tickets clear  topt">
    <h2 class="h2">Otros parques</h2>
    <div class="carousel-wrapper">
      <div class="carousel center">
        <ul class="ticket-list clear">
          <li class="item">
            <div class="image-wrapp">
              <a href="/Parques/Xcaret"><img src="/img/tour/parques/Experiencias-Xcaret/Xcaret/xcaret.png" alt=" " /></a>
            </div>
            <h3>
              <a href="/Parques/Xcaret">¡Xcaret, Orgullo de México!</a>
            </h3>
            <p>
              <a href="/Parques/Xcaret">Xcaret, Riviera Maya Quintana Roo, México.</a>
            </p>
          </li>
          <li class="item">
            <div class="image-wrapp">
