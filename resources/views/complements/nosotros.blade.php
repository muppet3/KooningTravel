...
<div class="container" >
	<div class="cuadro-contacto" >
		<div class="top-menu" >
			...
			<h1 class="titulo-internas"> ~ Nosotros ~ </h1>
		</div>
		
		<div class="nosotros" >
			<div class="kooning-us" >
				<div class="us-info">
					<h2 class="subtitulo-internas">¿Quienes Somos?</h2>
					<p class="parrafo">Empresa Mexicana fundada en la ciudad de Cancún, Quintana Roo, dedicada a la promoción de destinos y servicios del sector turístico. Nos enfocados a ofrecer las mejores tarifas a través de nuestra plataforma de comercialización online, diseñada para ofrecer al cliente una forma fácil y rápida para acceder a las mejores opciones y precios de hoteles y servicios turísticos en diferentes puntos del mundo, recibiendo en todo momento atención personalizada.
					</p>
				</div>
				<div class="us-left">
					<h3 class="minititulo-internas">VISIÓN</h3>
					<p class="parrafo"> Ser una red de servicios turísticos online líder en México, ofreciendo acceso a cientos de ofertas directas de hospedaje para turismo de negocio o vacacional preferente, de una manera sencilla, confiable y dinámica.</p>
				</div>
				<div class="us-right">
					<h3 class="minititulo-internas">MISIÓN</h3>
					<p class="parrafo">Ofrecer una plataforma especializada online, con el propósito de ofrecer al cliente experiencias únicas al reservar sus viajes con nosotros. Queremos caracterizarnos por brindar las mejores opciones al mejor precio, además de un seguimiento personalizado en través de internet, call center o redes sociales.</p>
				</div>
				<div class="us-bottom">
					<h4 class="subtitulo-internas">Nuestra principal razón de ser son nuestros clientes</h4>
					<p class="parrafo">Estamos seguros que la fidelización a nuestros principios y valores corporativos nos permiten alcanzar la excelencia en nuestro servicio:</p>
				</div>
			</div>
			<hr>
			<div class="kooning-us" >
