...
<div class="head home" > 
  ...
  <div class="inline-search position rbd">
    <select style="display:none;" required="true"  onclick="fd()" data-placeholder="Destino..." class="destination form-control" id="d" name="d" multiple="multiple" >
    </select>
  </div>
  <div class="inline-search date">
    <div class="input-style date-from noselect">
      <div class="date-wrapper from_datepicker-wrapper"> <span class="aa"><?php // echo o $dia1; ?></span> <span class="ee"> <span class="ii"><?php // echo o $mes; ?></span> <span class="uu"><?php // echo o $semana; ?></span> </span> </div>
    ...
    <div class="input-style date-to noselect">
      <div class="date-wrapper to_datepicker-wrapper" id="to_datepicker-wrapper"> <span class="aa"><?php // echo o $dia2; ?></span> <span class="ee"> <span class="ii"><?php // echo o $mes2; ?></span> <span class="uu"><?php // echo o $semana2; ?></span> </span> </div>
  ...
  <div class="inline-block">
          ...
          <ul class="rooms-list">
            <li class="item room-1 clear visible" data-room="1">
              ...
              <div class="child-ages" style="display: none;">
                <label class="sup-label">Edades de los niños en f// echo a de viaje</label>
    ...
    <button class="btn btn-circle enviarcorreo inline-button violet ir" id="enviar1" ></button>
  </div>
